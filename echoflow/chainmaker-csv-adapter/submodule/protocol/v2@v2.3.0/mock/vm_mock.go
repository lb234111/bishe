...
// CallContract mocks base method.
func (m *MockWacsi) CallContract(requestBody []byte, txSimContext protocol.TxSimContext, memory, data []byte, gasUsed uint64, isLen bool) (*common.ContractResult, uint64, protocol.ExecOrderTxType, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CallContract", requestBody, txSimContext, memory, data, gasUsed, isLen)
	ret0, _ := ret[0].(*common.ContractResult)
	ret1, _ := ret[1].(uint64)
...
// CallContract indicates an expected call of CallContract.
func (mr *MockWacsiMockRecorder) CallContract(requestBody, txSimContext, memory, data, gasUsed, isLen interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CallContract", reflect.TypeOf((*MockWacsi)(nil).CallContract), requestBody, txSimContext, memory, data, gasUsed, isLen)
}
...
// CallContract mocks base method.
func (m *MockTxSimContext) CallContract(contract *common.Contract, method string, byteCode []byte, parameter map[string][]byte, gasUsed uint64, refTxType common.TxType) (*common.ContractResult, protocol.ExecOrderTxType, common.TxStatusCode) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CallContract", contract, method, byteCode, parameter, gasUsed, refTxType)
	ret0, _ := ret[0].(*common.ContractResult)
	ret1, _ := ret[1].(protocol.ExecOrderTxType)
	ret2, _ := ret[2].(common.TxStatusCode)
	return ret0, ret1, ret2
...
func (mr *MockTxSimContextMockRecorder) CallContract(contract, method, byteCode, parameter, gasUsed, refTxType interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CallContract", reflect.TypeOf((*MockTxSimContext)(nil).CallContract), contract, method, byteCode, parameter, gasUsed, refTxType)
}
