...
func (m *MockNet) DirectMsgHandle(chainId, msgFlag string, handler protocol.DirectMsgHandler) error {
	m.ctrl.T.Helper()
	//Aid := "QmZg6bzzqvKrEENtb5ktu2XwWdCXrxKj96c2XK93RwoZst"
	//timestamp := time.Now().Format("2006-01-02 15:04:05")
	//if msgFlag == "NetMsg_TX"{
		//if chainId == Aid{
			//if err = SendMsg(chainId, Aid, "LATENCY_MSG_SEND", []byte(timestamp)); err != nil {
				//return err
			//}
		//}
	...
	//if msgFlag == "LATENCY_MSG_SEND"{
		//net.log.Infof("TX received, T4:%s", timestamp)
		//return nil
	//}
	//return nil
}
...
func (m *MockNet) SendMsg(chainId, node, msgFlag string, netMsg []byte) error {
	m.ctrl.T.Helper()
	// msgFlag == "NetMsg_TX"{
		//otocol.Logger.Infof("Send tx to peer %s, T1:%s", node, time.Now().Format("2006-01-02 15:04:05"))
	//
	// msgFlag == "LATENCY_MSG_SEND" && node == "QmZg6bzzqvKrEENtb5ktu2XwWdCXrxKj96c2XK93RwoZst"{
		//tMsg = bytes.Join(netMsg, []byte(time.Now().Format("2006-01-02 15:04:05")))
	//}
