...
const (
	...
	DefaultViewNumsPerEpoch uint64 = 10
...
func ConstructContractTxRwSet(
	...
	log.Debugf("update param-2 viewNumsPerEpoch: epochId %d, viewId %d,  viewNumsPerEpoch %d, endView %d", contract.EpochId, view, viewNumsPerEpoch, contract.EndView)
