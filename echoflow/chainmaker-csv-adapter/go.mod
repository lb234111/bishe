...
require (
	...
	chainmaker.org/chainmaker/consensus-tbft/v2 v2.4.2
...
replace (
	...
	chainmaker.org/chainmaker/localconf/v2 v2.3.0 => ./submodule/localconf
	chainmaker.org/chainmaker/net-libp2p v1.2.1 => ./submodule/net-libp2p@v1.2.0
	chainmaker.org/chainmaker/net-liquid => ./submodule/net-liquid@v1.1.0
	chainmaker.org/chainmaker/protocol/v2 => ./submodule/protocol/v2@v2.3.0
	chainmaker.org/chainmaker/recorderfile => ./submodule/recorderfile
	chainmaker.org/chainmaker/store/v2 => ./submodule/store
	chainmaker.org/chainmaker/txpool-batch/v2 => ./submodule/txpool-batch/v2@v2.3.0
	chainmaker.org/chainmaker/txpool-normal/v2 => ./submodule/txpool-normal/v2@v2.3.0
	chainmaker.org/chainmaker/txpool-single/v2 => ./submodule/txpool-single/v2@v2.3.0
)
